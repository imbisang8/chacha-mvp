...
"discovery_insight": "형식: '오늘 {이름}은 [구체적인 관찰 사실]. [그 관찰에서 조심스럽게 추측할 수 있는 해석 한 줄].' 최대 2문장. 실제 대화와 행동을 기반으로 작성하며 과도한 일반화·평가·칭찬·훈계는 금지한다. 발달 단계나 성격을 단정 짓지 말 것. 관찰되지 않은 감정이나 의도를 단정하지 말고, 실제 대화와 행동에서 확인된 내용만 바탕으로 작성할 것. 말투: 엄마에게 보내는 따뜻한 편지처럼 ~했어요 / ~보였어요 / ~것 같아요 체로 끝낼 것. '~했다' '~지점이다' 같은 보고서체는 절대 금지.",
