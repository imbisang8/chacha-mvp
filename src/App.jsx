...
const FIRST_ROUND = {
  adventure: [
    { chacha_says: ["나 그 장면 읽다가 심장 쫄렸다냥!", "너는 어땠어?"], choices: ["엄청 긴장됐어!", "별로 안 무서웠어", "나도 심장 쫄렸어!"] },
    { chacha_says: ["와... 차차도 모르게 숨을 참았다냥!", "너는 그때 어떤 느낌이었어?"], choices: ["나도 숨 참았어!", "별로 안 떨렸어", "손에 땀이 났어"] },
    { chacha_says: ["차차는 그 부분에서 책을 꽉 붙잡았다냥...", "넌 그때 뭐 하고 있었어?"], choices: ["나도 손에 땀났어!", "그냥 차분하게 봤어", "소리 지를 뻔했어"] },
  ],
  mystery: [
    { chacha_says: ["차차는 여기서 계속 궁금해서 책을 못 덮었다냥!", "너는 어떤 게 제일 궁금했어?"], choices: ["다음에 무슨 일이 생길지!", "주인공이 왜 그랬는지!", "결말이 어떻게 될지!"] },
    { chacha_says: ["잠깐만... 차차 머릿속에 물음표가 막 떠다닌다냥!", "넌 뭐가 제일 수상하다고 생각했어?"], choices: ["그 장면이 좀 이상했어!", "등장인물 행동이 수상했어", "아직 잘 모르겠어"] },
    { chacha_says: ["차차 여기서 자꾸 앞장을 다시 넘겨봤다냥...", "넌 뭔가 놓친 게 있었던 거 같아?"], choices: ["나도 다시 봤어!", "딱히 그렇진 않았어", "한 번 더 보고 싶어졌어"] },
  ],
  comedy: [
    { chacha_says: ["나 여기서 웃다가 책 떨어뜨림 ㅋㅋ", "제일 웃겼던 장면이 어디야?"], choices: ["처음부터 웃겼어!", "중간에 빵 터졌어", "끝이 제일 웃겼어"] },
    { chacha_says: ["잠깐, 차차 진짜 소리내서 웃었다냥 ㅋㅋㅋ", "넌 어디서 제일 웃겼어?"], choices: ["그 장면에서 빵 터졌어!", "나도 웃겼는데 참았어", "처음부터 웃겼어"] },
    { chacha_says: ["이거... 차차 진짜 입틀막했다냥", "넌 어디서 웃참했어?"], choices: ["완전 못 참았어!", "살짝 웃참했어", "계속 웃참했어"] },
  ],
  emotion: [
    { chacha_says: ["차차도 읽다가 뭔가 마음이 찡했다냥...", "너는 어떤 장면이 제일 마음에 남았어?"], choices: ["처음 장면!", "중간 장면!", "마지막 장면!"] },
    { chacha_says: ["차차... 이 부분에서 잠깐 멍해졌다냥", "넌 어떤 장면이 그랬어?"], choices: ["처음 장면!", "중간 장면!", "마지막 장면!"] },
    { chacha_says: ["차차 마음이 좀 몽글몽글해졌다냥...", "어떤 장면이 그렇게 만들었어?"], choices: ["처음 장면!", "중간 장면!", "마지막 장면!"] },
  ],
};
const SECOND_ROUND = {
  adventure: [
    { chacha_says: ["오~ 그 장면이 그렇게 느껴졌구나냥", "어떤 생각이 들었어?"], choices: ["주인공이 용감해서!", "위험해 보여서", "나도 모르겠어"] },
    { chacha_says: ["음... 차차는 그 장면 보고 좀 떨렸다냥", "넌 그때 무슨 생각했어?"], choices: ["주인공이 멋있어서!", "좀 위험해 보여서", "그냥 신기했어"] },
    { chacha_says: ["차차도 그 부분 보고 자세 고쳐 앉았다냥", "넌 왜 그렇게 느꼈어?"], choices: ["주인공이 용감해서!", "위험한 상황이라서", "잘 모르겠어"] },
  ],
  mystery: [
    { chacha_says: ["흠... 차차는 그 장면이 계속 생각나더라냥", "어떤 부분이 제일 신기했어?"], choices: ["단서가 있었어!", "그냥 느낌!", "다른 캐릭터 때문에"] },
    { chacha_says: ["차차 그 장면 보고 한참 생각했다냥...", "넌 어떤 부분이 제일 걸렸어?"], choices: ["단서가 있었어!", "그냥 느낌이 이상했어", "다른 사람 때문에"] },
    { chacha_says: ["음... 차차 머릿속에 그 장면이 계속 맴돈다냥", "넌 왜 그게 신경 쓰였어?"], choices: ["단서가 있어서!", "느낌이 그래서", "다른 사람 때문에"] },
  ],
  comedy: [
    { chacha_says: ["ㅋㅋ 차차도 거기서 웃겼냥", "어느 부분이 제일 기억에 남았어?"], choices: ["너무 황당해서!", "주인공이 바보 같아서", "예상 밖이라서"] },
    { chacha_says: ["차차도 거기서 같이 웃었다냥 ㅋㅋ", "넌 왜 그게 그렇게 웃겼어?"], choices: ["너무 황당해서!", "주인공이 엉뚱해서", "예상 못해서"] },
    { chacha_says: ["음... 차차도 그 부분에서 피식했다냥", "넌 그게 왜 웃겼어?"], choices: ["너무 황당해서!", "주인공이 웃겨서", "갑자기라서"] },
  ],
  emotion: [
    { chacha_says: ["그 장면... 차차도 좀 마음이 쓰였다냥", "그때 어떤 마음이었어?"], choices: ["주인공이 불쌍해서", "나도 비슷한 적 있어서", "결말이 슬퍼서"] },
    { chacha_says: ["차차도 그 장면 보고 마음이 좀 그랬다냥...", "넌 어떤 마음이 들었어?"], choices: ["주인공이 안타까워서", "나도 그런 적 있어서", "슬픈 결말이라서"] },
    { chacha_says: ["음... 차차도 그 부분에서 마음이 무거웠다냥", "넌 왜 그런 마음이 들었어?"], choices: ["주인공이 불쌍해서", "비슷한 경험이 있어서", "슬퍼서"] },
  ],
};
const THIRD_ROUND = {
  adventure: [
    { chacha_says: ["차차는 사실 겁쟁이라 못 했을 것 같은데냥 ㅠ", "너라면 어떻게 했을 것 같아?"], choices: ["나도 용감하게 했을 거야!", "솔직히 도망갔을 것 같아", "친구랑 같이 했을 거야"] },
    { chacha_says: ["차차는 그 상황이면 그냥 숨었을 것 같다냥...", "너라면 어떻게 했을 것 같아?"], choices: ["나도 똑같이 했을 거야!", "좀 더 조심했을 거야", "도와줄 사람을 찾았을 거야"] },
    { chacha_says: ["음... 차차라면 그 자리에서 얼음이 됐을 것 같다냥", "너라면 어떻게 했을 것 같아?"], choices: ["용기내서 했을 거야!", "도망갔을 거야", "잘 모르겠어"] },
  ],
  mystery: [
    { chacha_says: ["차차라면 끝까지 궁금해서 잠도 못 잤을 것 같다냥", "너라면 어떻게 했을 것 같아?"], choices: ["응 나 맞출 수 있었어!", "아마 틀렸을 것 같아", "더 단서 모았을 거야"] },
    { chacha_says: ["차차라면 그 부분에서 계속 추측만 했을 것 같다냥", "너라면 어떻게 했을 것 같아?"], choices: ["맞췄을 것 같아!", "아마 못 맞췄을 거야", "다시 처음부터 봤을 거야"] },
    { chacha_says: ["음... 차차는 거기서 완전 헷갈렸을 것 같다냥", "너라면 뭘 먼저 했을 것 같아?"], choices: ["단서를 더 찾아봤을 거야!", "그냥 넘어갔을 거야", "누군가에게 물어봤을 거야"] },
  ],
  comedy: [
    { chacha_says: ["차차라면 거기서 완전 뻘쭘했을 것 같은데냥", "너라면 어떻게 했을 것 같아?"], choices: ["나도 웃겼을 것 같아!", "나는 안 그랬을 것 같은데", "더 웃기게 했을 거야"] },
    { chacha_says: ["차차라면 그 상황에서 도망갔을 것 같다냥 ㅋㅋ", "너라면 어떻게 했을 것 같아?"], choices: ["나도 똑같이 했을 거야!", "절대 안 그랬을 거야", "더 크게 웃었을 거야"] },
    { chacha_says: ["음... 차차는 그 자리에서 얼굴이 빨개졌을 것 같다냥", "너라면 어떻게 했을 것 같아?"], choices: ["나도 그랬을 거야!", "난 안 그랬을 듯", "더 신나게 했을 거야"] },
  ],
  emotion: [
    { chacha_says: ["차차는 그 상황에서 어떻게 해야 할지 몰랐을 것 같다냥...", "너라면 어떻게 했을 것 같아?"], choices: ["옆에 있어줬을 거야", "도와주려고 했을 것 같아", "나도 어떻게 할지 몰랐을 것 같아"] },
    { chacha_says: ["차차라면 그 자리에서 아무 말도 못했을 것 같다냥...", "너라면 뭐라고 했을 것 같아?"], choices: ["괜찮다고 해줬을 거야", "같이 있어줬을 거야", "나도 잘 모르겠어"] },
    { chacha_says: ["음... 차차는 그 장면 보고 한참 멍했을 것 같다냥", "너라면 어떻게 했을 것 같아?"], choices: ["손을 잡아줬을 거야", "위로해줬을 거야", "나도 무슨 말을 해야 할지 몰랐을 거야"] },
  ],
};
...
const firstRound = pickVariant(FIRST_ROUND[genre] || FIRST_ROUND.adventure);
...
const getHardcodedRound = (rNum, book) => {
    ...
    if (rNum === 1) return pickVariant(FIRST_ROUND[g] || FIRST_ROUND.adventure);
    if (rNum === 2) return pickVariant(SECOND_ROUND[g] || SECOND_ROUND.adventure);
    if (rNum === 3) return pickVariant(THIRD_ROUND[g] || THIRD_ROUND.adventure);
    return null;
  };
