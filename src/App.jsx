...
const SECOND_ROUND = {
  ...
  mystery:   { chacha_says: ["흠... 차차는 그 부분이 좀 이상하더라냥", "뭐가 그렇게 느껴졌어?"], choices: ["단서가 있었어!", "그냥 느낌!", "다른 캐릭터 때문에"] },
...
"discovery_insight": "형식: '오늘 {이름}은 [구체적인 관찰 사실]. [그 관찰에서 조심스럽게 추측할 수 있는 해석 한 줄].' 최대 2문장. 실제 대화와 행동을 기반으로 작성하며 과도한 일반화·평가·칭찬·훈계는 금지한다. 발달 단계나 성격을 단정 짓지 말 것.",
...
"polaroid_text": "차차가 오늘 가장 기억에 남은 아이의 실제 말이나 행동 하나를 떠올리며 남기는 한 줄 메모. 차차다운 귀엽고 가벼운 말투를 사용하고, 실제 대화 내용을 바탕으로 매번 다르게 작성한다. 반드시 '~냥'으로 끝낸다.",
